...
class EditCourse extends React.Component {
  ...
  updateCourse = async e => {
    if (
      ...
      this.state.editedCourseCredits > 100 ||
      ...
      if (!isNaN(this.state.editedCourseGoalTarget)) {
        //Jos kurssilla on jo olemassa goal päivitetään olemassaolevaa

        if (
          this.state.editedCourseGoalTarget >= 1 &&
          this.state.editedCourseGoalTarget <= 5
        ) {
          let tempGoal = {
            courseid: this.props.course._id,
            userid: this.props.user._id,
          ...
          >
            ...
            >
              ...
              <Input
                id="length-simple"
                type="number"
                name="editedCourseLength"
                value={this.state.editedCourseLength}
                onChange={event => this.handleFormChange(event)}
              />
            </FormControl>
            ...
            >
              ...
              <Input
                id="credits-simple"
                type="number"
                name="editedCourseCredits"
                value={this.state.editedCourseCredits}
                onChange={event => this.handleFormChange(event)}
              />
            </FormControl>
