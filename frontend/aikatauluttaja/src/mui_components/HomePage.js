...
class HomePage extends React.Component {
  ...
  render() {
    ...
    if (this.props.user === null) { //Jos user on null, renderöidään kirjautumattoman käyttäjän etusivu:
      return (
        <Fragment>
    ...
    } else if (this.state.user !== undefined) { //Jos käyttäjä ole olemassa, rendöidään sen tiedot ja suosituksia yms.
      return (
        <Fragment>
          ...
          <Grid item md={6} xs={12}>
            <Paper style={{ padding: 30, marginTop: 10, marginLeft: 10, marginRight: 10 }} elevation={1}>
              <Typography paragraph={true} variant="body1">
                ...
                <br></br>
                <a target="_blank" rel="noopener noreferrer" href="https://wiki.helsinki.fi/pages/viewpage.action?pageId=244747659">Matematiikan ja tilastotieteen laitoksen kurssitarjonta</a>
              </Typography>
            </Paper>
          </Grid>
        </Fragment >
