...
| 17.6 | 2h20min | Parannettu Etusivulla renderöitävien komponenttien skaalautuvuutta suurilla näytöillä. Lisätty backendin Goal-objektille kenttä difficulty. Toteutettu kurssilistaukseen hienommat select-komponentit tavoitearvosanalle ja haastavuudelle. Kurssin haastavuuden voi asettaa suoraan kurssilistauksesta. Kurssin haastavuutta voi muokata EditCourse komponentin kautta. Parannettu usean komponentin ulkoasua. Yksinkertaistettu Course komponentin render metodia. |